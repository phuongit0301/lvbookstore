...
@section('content')
	...
	<div class="container-top blocks-area">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
		
					<div class="container-title text-left">
					  <h3 class="titles text-left">TRUYỆN ĐỀ CỬ</h3>
					</div>
	...
	<div class="container-new blocks-area">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
		
					<div class="container-title text-left">
					  <h3 class="titles text-left">TRUYỆN MỚI CẬP NHẬT</h3>
					</div>
				...
				<div class="col-md-9">
					<div class="story-finish">
						<div class="row">
							<div class="col-lg-12">
								<div class="container-title text-left">
								  <h3 class="titles text-left">TRUYỆN ĐÃ HOÀN THÀNH</h3>
								</div>
							</div>
						</div>

						<div class="content-story-finish">
							<div class="row">
								<div class="col-lg-2">
									<div class="item">
										<figure class="block-books">
							...
							</div><!--end content-story-finish-->
						</div>
					</div><!--end story-finish-->
				</div>
			</div>
		</div>
